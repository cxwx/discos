...
**  - - - - - - - - -
**
**  Quick ICRS place, epoch J2000, to CIRS, given the star-independent
**  parameters.
**
...
**      eb[3]      double    SSB to observer (AU)
**      ehn[3]     double    Sun to observer unit vector
**      gr2e       double    (Schwarzschild rad Sun)/(Sun-observer dist)
...
/* Topocentric direction of star (normalized, ICRS). */
   for ( i = 0; i < 3; i++ ) {
