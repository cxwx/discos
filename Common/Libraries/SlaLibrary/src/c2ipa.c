...
**  preparation for conversions between ICRS star data and CIRS RA,Dec.
**
**  The parameters produced by this function are required in the proper
**  motion, parallax, light deflection, aberration and
**  precession-nutation parts of the ICRS/CIRS transformations.
**
**  Given:
**     date    double     TDB (JD-2400000.5)
**     dx,dy   double     corrections to IAU 2006/2000A CIP X,Y (radians)
**
**  Returned:
...
**      gr2e       double    (Schwarzschild rad Sun)/(Sun-Earth distance)
**      abv[3]     double    barycentric observer velocity in units of c
...
**  Called:  slaC2ipas
**
**  Last revision:   14 September 2012
**
